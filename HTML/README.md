...
## <a href="https://github.com/dudcks5477/Front-end/tree/master/HTML/ex6.html">전역 속성</a>
```html
<태그 title="설명"></태그>
<태그 style="스타일"></태그>
<태그 class="이름"></태그>
...
<태그 data-이름="데이터"></태그>
```
- title : 요소의 **정보** 나 **설명** 을 지정
- style : 요소에 적용할 **스타일(CSS)** 을 지정
- class : 요소를 지칭하는 **중복 가능** 한 이름
- id : 요소를 지칭하는 **고유** 한 이름
- data-이름 : 요소에 **데이터** 를 지정
  - SCRIPT 요소에 **defer** 속성은, HTML 구조가 준비된 후(문서 분석 이후)에 JavaScript를 해석하겠따는 의미가 있다.